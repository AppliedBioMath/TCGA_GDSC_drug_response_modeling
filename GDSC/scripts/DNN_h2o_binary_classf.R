...
train <- read.csv("/Users/sgujja/repos/TCGA_drug_response_nonresponse/GDSC/scripts/GDSC_Gemcitabine_100cuts/Gemcitabine_Affy_DE_TrainingSet_new_86.csv",sep=",", header=T,row.names = 1,stringsAsFactors = F, check.names = F )[,-1]
test <- read.csv("/Users/sgujja/repos/TCGA_drug_response_nonresponse/GDSC/scripts/GDSC_Gemcitabine_100cuts/Gemcitabine_Affy_DE_TestingSet_new_86.csv",sep=",", header=T, row.names = 1 ,stringsAsFactors = F, check.names = F)[,-1]
